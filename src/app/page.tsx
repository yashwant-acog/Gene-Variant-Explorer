...
export default function LandingPage() {
  ...
  return (
    <div className="h-full overflow-y-auto flex flex-col items-center justify-center bg-white dark:bg-scientific-bg px-4 py-12">
      <div className="max-w-3xl w-full text-center space-y-12">
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            A comprehensive intelligence dashboard for exploring genetic
            variants, clinical consequences, and population frequencies across
            the human genome.
          </p>
        </div>
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <span className="text-sm font-medium text-gray-400 uppercase tracking-widest mr-2">
              Suggestions:
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 animate-in fade-in slide-in-from-bottom-12 duration-700 delay-500">
          <div className="p-6 bg-white dark:bg-scientific-panel rounded-2xl border border-gray-100 dark:border-scientific-border shadow-sm text-left group hover:shadow-md transition-all">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Detailed allele frequencies across global and specific populations
              from gnomAD.
            </p>
          </div>
          <div className="p-6 bg-white dark:bg-scientific-panel rounded-2xl border border-gray-100 dark:border-scientific-border shadow-sm text-left group hover:shadow-md transition-all">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Real-time visualization of CADD, REVEL, and SpliceAI scores for
          ...
          <div className="p-6 bg-white dark:bg-scientific-panel rounded-2xl border border-gray-100 dark:border-scientific-border shadow-sm text-left group hover:shadow-md transition-all">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Curated associations between variants and phenotypic outcomes from
