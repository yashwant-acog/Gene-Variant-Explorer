...
export default function AppLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen flex flex-col items-stretch">
            <header className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-scientific-border bg-white/80 dark:bg-scientific-panel/80 backdrop-blur">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/" className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-xl hidden sm:inline-block tracking-tight">
                                Biomarin Gene <span className="text-primary-600 dark:text-scientific-accent font-medium">Variant Explorer</span>
                            </span>
                        </Link>
                    </div>

                    <nav className="flex items-center gap-6">
                        <Link href="/" className="text-sm font-medium hover:text-primary-600 dark:hover:text-scientific-accent transition-colors">
                            Dashboard
                        </Link>
            ...
            <footer className="w-full border-t border-gray-200 dark:border-scientific-border bg-white dark:bg-scientific-panel py-6">
                <div className="container mx-auto px-4 text-center text-sm text-gray-500 dark:text-gray-400">
                    <p>&copy; {new Date().getFullYear()} Biomarin Gene Variant Explorer.</p>
                </div>
            </footer>
        </div>
    );
