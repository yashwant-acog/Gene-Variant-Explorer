...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col items-stretch min-h-screen bg-white dark:bg-[#0f172a]">
      ...
      <main className=" min-h-0 bg-grid-pattern relative">{children}</main>

      <footer className="flex-none w-full border-t border-gray-200 dark:border-scientific-border bg-white dark:bg-scientific-panel py-6">
